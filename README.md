...
- Line 258: TODO see if the remainder of the section can be shortened,
  it seems a bit repetitive
- Line 349: TODO: review and smooth this section
- Line 401: GIOVANNI: i have added a small section and simulation about
...
- Line 712: GIOVANNI: is sigma the residual variance or the effect size
...
- Line 476: TODO see if the remainder of the section can be shortened,
  it seems a bit repetitive
- Line 599: TODO: review and smooth this section
- Line 646: GIOVANNI: i have added a small section and simulation about
  typeM error by gelman. I think that is interesting because shows the
  amount of effect size inflation given the sample size when selecting
  for significance
- Line 748: TODO: describe standardized vs unstandardized
- Line 750: GIOVANNI: is sigma the residual variance or the effect size
  sampling variability?
