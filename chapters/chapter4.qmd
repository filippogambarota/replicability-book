<!-- TODO:  table with method (rows), (colums)properties, id exact or extension, bayesian or not, open source code, citation -->

# Statistical methods for replication assessment

```{r}
funs <- filor::get_funs(here::here("R", "simulating-data.R"))
devtools::load_all()
```
...
theta <- rnorm(R, mu, sqrt(tau2)) # true effects for R studies
